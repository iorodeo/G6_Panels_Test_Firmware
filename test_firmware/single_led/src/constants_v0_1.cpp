...
// Hardware revision v0.1 (RP2354A02)
// LED polarity is inverted: COL driven low to turn on, ROW driven high.
...
const uint8_t COL_ON_LEVEL = 0;
const uint8_t ROW_ON_LEVEL = 1;
